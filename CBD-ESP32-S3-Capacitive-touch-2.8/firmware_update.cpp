// =============================================================================
// WontHound-CYD SD Card Firmware Update
...
static void drawFileList() {
    ...
    for (int i = 0; i < visible; i++) {
        ...
        // Background
        if (isSelected) {
            tft.fillRoundRect(4, y, listItemW, FW_ITEM_HEIGHT - 2, 4, WONTHOUND_MAGENTA);
        } else {
            tft.drawRoundRect(4, y, listItemW, FW_ITEM_HEIGHT - 2, 4, WONTHOUND_GUNMETAL);
        }

        // File name
        tft.setTextSize(1);
        tft.setTextColor(isSelected ? TFT_BLACK : WONTHOUND_HOTPINK);
        ...
        tft.setTextColor(isSelected ? TFT_BLACK : WONTHOUND_GUNMETAL);
...
static void drawFlashButton(bool enabled) {
    ...
    tft.fillRoundRect(btnX, btnY, btnW, 36, 8,
                      enabled ? TFT_GREEN : WONTHOUND_GUNMETAL);
    tft.setTextSize(2);
...
static void drawProgressScreen(const char* fileName) {
    ...
    tft.drawRect(19, SCALE_Y(115), barW + 2, 22, WONTHOUND_MAGENTA);
