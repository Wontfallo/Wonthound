...
#define EEPROM_MAGIC 0xCD0A   // Bumped from 0xCD09 — 3E panel default now inverted (correct colors)
...
void loadSettings() {
    ...
    if (settings.magic != EEPROM_MAGIC) {
        ...
        #else
        settings.displayInverted = 1;  // this CYD ILI9341 panel needs inversion ON (else colors look negative)
        #endif
