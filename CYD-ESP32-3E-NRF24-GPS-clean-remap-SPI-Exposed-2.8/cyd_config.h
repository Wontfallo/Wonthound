...
// ═══════════════════════════════════════════════════════════════════════════
#if defined(CYD_28) && !defined(ESP32S3_ES3C28P)
  #ifdef CYD_E32R28T
...
// ═══════════════════════════════════════════════════════════════════════════
  ...
  // P4 pin 2 IO35 -> GPS TX (GPS RX on ESP32). NRF24 IRQ is unused by the
  // firmware, so GPIO35 is given to the GPS instead (see GPS_RX_PIN below).
  #define NRF24_CSN     27
  #define NRF24_CE      16
  #define NRF24_IRQ     -1    // freed: GPIO35 reused for GPS RX
...
// ═══════════════════════════════════════════════════════════════════════════
  ...
  #define GPS_TX_PIN    -1
#elif defined(FREENOVE_E32R28T_P3_NRF24)
  #define GPS_RX_PIN    35    // GPS TX -> ESP32 IO35 (P4, input-only); freed from NRF24 IRQ
  #define GPS_TX_PIN    -1    // GPS is receive-only
#else
...
#if defined(CYD_35) || defined(ESP32S3_ES3C28P)
...
#define SUBMENU_TOUCH_H     SCALE_Y(28)     // Touch hit area height (matches font-4 row height)
