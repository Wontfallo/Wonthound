// ═══════════════════════════════════════════════════════════════════════════
// WontHound-CYD Karma Attack Module
// Probe request listener + rogue AP responder
// WontHound Karma implementation
// Created: 2026-02-16
//
...
static void drawCollectScreen() {
    ...
    tft.drawLine(5, SCALE_Y(76), GRAPH_PADDED_W, SCALE_Y(76), WONTHOUND_VIOLET);
    ...
    tft.print("CLIENT");
    tft.drawLine(5, SCALE_Y(90), GRAPH_PADDED_W, SCALE_Y(90), WONTHOUND_GUNMETAL);
...
static void updateCollectDisplay() {
    ...
    // Stats values
    tft.fillRect(SCALE_X(50), SCALE_Y(64), SCALE_W(45), 10, WONTHOUND_BLACK);
    tft.setTextColor(WONTHOUND_MAGENTA);
    tft.setCursor(SCALE_X(50), SCALE_Y(64));
    tft.print(totalProbes);

    tft.fillRect(SCALE_X(140), SCALE_Y(64), SCALE_W(30), 10, WONTHOUND_BLACK);
    tft.setCursor(SCALE_X(140), SCALE_Y(64));
    tft.print(ssidCount);

    tft.fillRect(SCREEN_WIDTH - 15, SCALE_Y(64), 15, 10, WONTHOUND_BLACK);
    ...
    tft.fillRect(5, listY, GRAPH_PADDED_W, listH, WONTHOUND_BLACK);
    ...
    for (int i = 0; i < showCount; i++) {
        ...
        // SSID name
        tft.setTextColor(recent ? WONTHOUND_MAGENTA : WONTHOUND_VIOLET);
        tft.setCursor(10, y);
        char truncSSID[28];
        ...
        // Separator line
        tft.drawFastHLine(10, y + lineH - 3, CONTENT_INNER_W, WONTHOUND_DARK);
    }
...
static void drawAttackScreen() {
    ...
    tft.drawLine(5, SCALE_Y(82), GRAPH_PADDED_W, SCALE_Y(82), WONTHOUND_VIOLET);
