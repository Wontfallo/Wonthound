// ═══════════════════════════════════════════════════════════════════════════
// WontHound-CYD SubGHz Configuration Implementation
...
void saveSetup() {
    ...
    tft.setTextSize(2);
    drawCenteredText(50, "SAVED PROFILES", WONTHOUND_HOTPINK, 2);

    // Show stub message
    drawCenteredText(90, "COMING SOON", WONTHOUND_MAGENTA, 2);
...
void subjammerSetup() {
    ...
    tft.setTextColor(WONTHOUND_HOTPINK);
    tft.setTextSize(2);
    drawCenteredText(50, "SUBGHZ JAMMER", WONTHOUND_HOTPINK, 2);
    drawCenteredText(90, "CC1101 REQUIRED", WONTHOUND_MAGENTA, 2);
...
void subBruteSetup() {
    ...
    tft.setTextColor(WONTHOUND_HOTPINK);
    tft.setTextSize(2);
    drawCenteredText(50, "BRUTE FORCE", WONTHOUND_HOTPINK, 2);
    drawCenteredText(90, "CC1101 REQUIRED", WONTHOUND_MAGENTA, 2);
