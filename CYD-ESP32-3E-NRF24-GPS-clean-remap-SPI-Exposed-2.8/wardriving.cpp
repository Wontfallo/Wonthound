...
bool wardrivingStart() {
    ...
    logFile.println("WigleWifi-1.6,appRelease=WontHound-CYD,model=ESP32-CYD,release=3.0.0,device=WontHound,display=CYD,board=ESP32,brand=Wontfallo,star=Sol,body=3,subBody=0");
