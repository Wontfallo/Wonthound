// ═══════════════════════════════════════════════════════════════════════════
// WontHound-CYD SPI Bus Manager Implementation
...
void spiManagerSetup() {
    ...
    digitalWrite(SD_CS, HIGH);
    #if CYD_DEBUG
    Serial.printf("[SPI]   SD Card CS (GPIO %d) configured\n", SD_CS);
    #endif
    #endif
    ...
    digitalWrite(PN532_CS, HIGH);
    #if CYD_DEBUG
    Serial.printf("[SPI]   PN532 CS (GPIO %d) configured\n", PN532_CS);
    #endif
    #endif
    ...
    Serial.printf("[SPI]   VSPI: SCK=%d, MISO=%d, MOSI=%d\n", VSPI_SCK, VSPI_MISO, VSPI_MOSI);
    #endif
}
...
void spiPrintStatus() {
    ...
    #if CYD_HAS_SDCARD
    Serial.printf("  SD Card (GPIO %d):  ", SD_CS);
    ...
    #if CYD_HAS_PN532
    Serial.printf("  PN532 (GPIO %d):   ", PN532_CS);
