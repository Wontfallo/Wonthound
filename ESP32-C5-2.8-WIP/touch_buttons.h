...
// ═══════════════════════════════════════════════════════════════════════════
// WontHound-CYD Touch Button Handler
...
#ifdef CYD_CAP_TOUCH
  #define TOUCH_DEBOUNCE_MS     15      // Capacitive controllers are stable and should feel immediate
#else
...
// Shared top-left BACK hitbox used by feature screens with custom icon bars.
bool isTopLeftBackTouch(uint16_t *x = nullptr, uint16_t *y = nullptr);
