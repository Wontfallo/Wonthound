...
// ═══════════════════════════════════════════════════════════════════════════
// WontHound-CYD Master Pin Configuration
...
// Freenove E32R28T with E01-ML01DP5 wired to P3/P4/IO16 uses the same
// display/touch hardware as E32R28T, but NRF24 CSN is on P3 SPI_CS (GPIO27).
...
#ifdef FREENOVE_E32R28T_P3_NRF24
  #define FW_EDITION   "Freenove E32R28T P3 NRF24"
  #define FW_DEVICE    "WontHound-Freenove-E32R28T"
#elif defined(ESP32C5_NM_CYD)
  #define FW_EDITION   "ESP32-C5 NM-CYD-C5 5GHz"
  #define FW_DEVICE    "WontHound-ESP32C5-NM-CYD-C5"
#elif defined(ESP32S3_ES3C28P)
  #define FW_EDITION   "ESP32-S3 ES3C28P FT6336"
  #define FW_DEVICE    "WontHound-ESP32S3-ES3C28P"
#elif defined(CYD_3248S035C)
  #define FW_EDITION   "CYD35C Edition"
  #define FW_DEVICE    "WontHound-CYD35C"
#elif defined(CYD_35)
  #define FW_EDITION   "E32R35T Edition"
  #define FW_DEVICE    "WontHound-E32R35T"
#elif defined(NMRF_HAT)
  #define FW_EDITION   "CYD-HAT Edition"
  #define FW_DEVICE    "WontHound-CYD-HAT"
#elif defined(CYD_E32R28T)
  #define FW_EDITION   "E32R28T Edition"
  #define FW_DEVICE    "WontHound-E32R28T"
#else
  #define FW_EDITION   "CYD Edition"
  #define FW_DEVICE    "WontHound-CYD"
#endif
...
// ═══════════════════════════════════════════════════════════════════════════
  ...
  #define CYD_BOARD_NAME    "WontHound-CYD 2.8\""
  ...
  #undef  CYD_BOARD_NAME
  #define CYD_BOARD_NAME    "WontHound-E32R28T 2.8\""
#endif

#ifdef FREENOVE_E32R28T_P3_NRF24
  #undef  CYD_BOARD_NAME
  #define CYD_BOARD_NAME    "Freenove E32R28T P3 NRF24"
#endif
  ...
  #define CYD_TFT_BL        45    // Backlight on GPIO45
#endif
  ...
  #define CYD_TFT_BL        25    // Backlight on GPIO25
#endif

#ifdef CYD_35
  #undef  CYD_BOARD_NAME
  #define CYD_BOARD_NAME    "WontHound-E32R35T 3.5\""
  ...
  #undef  CYD_BOARD_NAME
  #define CYD_BOARD_NAME    "WontHound-CYD35C 3.5\""
#endif
...
// ═══════════════════════════════════════════════════════════════════════════
#ifdef ESP32C5_NM_CYD
  #define CYD_TFT_MISO     2
  #define CYD_TFT_MOSI     7
  #define CYD_TFT_SCLK     6
  #define CYD_TFT_CS      23
  #define CYD_TFT_DC      24
  #define CYD_TFT_RST     -1    // LCD reset tied to ESP reset
#elif defined(ESP32S3_ES3C28P)
...
#ifdef CYD_FT6336_TOUCH
  // ESP32-S3 ES3C28P: FT6336 capacitive touch via I2C
  // P4 exposes these same I2C lines, so keep them reserved for touch/audio.
  #define FT6336_SDA    16
  #define FT6336_SCL    15
  #define FT6336_RST    18
  #define FT6336_INT    17
...
#elif defined(ESP32C5_NM_CYD)
  // NM-CYD-C5: XPT2046 shares the ST7789 SPI bus; TFT_eSPI drives it.
  #define CYD_TOUCH_CS    1
...
// ═══════════════════════════════════════════════════════════════════════════
#ifdef ESP32C5_NM_CYD
  #define VSPI_SCK       6    // Shared C5 SPI clock
  #define VSPI_MOSI      7    // Shared C5 SPI MOSI
  #define VSPI_MISO      2    // Shared C5 SPI MISO
#elif defined(ESP32S3_ES3C28P)
  #define VSPI_SCK      14    // P3 IO14 -> NRF24 SCK
  #define VSPI_MOSI     21    // P3 IO21 -> NRF24 MOSI
  #define VSPI_MISO      3    // P3 IO3  -> NRF24 MISO
#else
...
#ifdef ESP32C5_NM_CYD
  #define SD_CS         10    // NM-CYD-C5 onboard SD CS
#elif defined(ESP32S3_ES3C28P)
  #define SD_CS         40    // S3 onboard SD is SDIO, not SPI; keep SPI-SD disabled
  #define CYD_SD_USE_SD_MMC 1
...
// See: https://github.com/wontfallo
//
...
// This matches the WontHound fix for CiferTech's swapped pins.
//
// ═══════════════════════════════════════════════════════════════════════════

#ifdef ESP32C5_NM_CYD
  #define CC1101_CS      9    // NM-RF-HAT switch path
#elif defined(ESP32S3_ES3C28P)
  #define CC1101_CS     47    // CC1101 disabled on this target; park CS on SDIO D3
#elif defined(CYD_3248S035C)
...
#endif
#ifdef ESP32C5_NM_CYD
  #define CC1101_GDO0    8    // Shared with NRF24 CE through the NM-RF-HAT switch
  #define CC1101_GDO2    8
#elif defined(ESP32S3_ES3C28P)
  #define CC1101_GDO0   47    // CC1101 disabled on this target
  #define CC1101_GDO2   48
#else
  #define CC1101_GDO0   22    // TX data TO radio - P3 connector
#endif
#ifdef NMRF_HAT
  #define CC1101_GDO2   22    // Hat: no GDO2 wire — GDO0 outputs same RX data
#elif !defined(ESP32S3_ES3C28P) && !defined(ESP32C5_NM_CYD)
...
// RCSwitch compatibility (WontHound pin naming)
...
// ═══════════════════════════════════════════════════════════════════════════
#if defined(CYD_28) && !defined(ESP32S3_ES3C28P) && !defined(ESP32C5_NM_CYD)
  #ifdef CYD_E32R28T
...
#elif defined(FREENOVE_E32R28T_P3_NRF24)
  // Freenove E32R28T P3/P4 wiring:
  // P3 pin 4 SPI_CS = GPIO27 -> NRF24 CSN
  // IO16 RGB pad -> NRF24 CE
  // P4 pin 2 IO35 -> optional NRF24 IRQ (input-only, not required by firmware)
  #define NRF24_CSN     27
  #define NRF24_CE      16
  #define NRF24_IRQ     35
  #define NRF24_SHARES_CC1101_CS 1
#elif defined(ESP32C5_NM_CYD)
  // NM-CYD-C5 NM-RF-HAT: physical switch selects CC1101 or NRF24 on the same pins.
  #define NRF24_CSN      9
  #define NRF24_CE       8
  #define NRF24_IRQ     -1
  #define NRF24_SHARES_CC1101_CS 1
#elif defined(ESP32S3_ES3C28P)
  // ESP32-S3 ES3C28P/ES3N28P:
  // P3 provides four free GPIOs for SPI+CSN. P2 UART0 pins are free because
  // this board uses native USB CDC over Type-C for upload/serial.
  #define NRF24_CSN      2    // P3 IO2  -> NRF24 CSN
  #define NRF24_CE      43    // P2 TXD0 -> NRF24 CE
  #define NRF24_IRQ     44    // P2 RXD0 -> optional NRF24 IRQ
...
#ifdef ESP32C5_NM_CYD
  #define PN532_CS      28    // External SPI PN532 CS on free C5 GPIO
#elif defined(ESP32S3_ES3C28P)
  #define PN532_CS      48    // PN532 disabled on this target; park CS on SDIO D2
#else
...
#ifdef ESP32C5_NM_CYD
  #define GPS_RX_PIN     4    // Optional GPS on CH340 header
  #define GPS_TX_PIN     5
#elif defined(ESP32S3_ES3C28P)
  #define GPS_RX_PIN    -1    // P2 UART pins are reserved for NRF24 CE/IRQ
  #define GPS_TX_PIN    -1
#else
...
// ═══════════════════════════════════════════════════════════════════════════
// WONTHOUND-ALPHA (C5 CO-PROCESSOR) LINK
// ═══════════════════════════════════════════════════════════════════════════
...
#define HLP_BAUD      460800  // WontHound Link Protocol baud rate
...
#ifdef ESP32C5_NM_CYD
  #define UART_MON_P1_RX     12
  #define UART_MON_P1_TX     11
#elif defined(ESP32S3_ES3C28P)
  #define UART_MON_P1_RX     -1    // P2 RXD0 reserved for optional NRF24 IRQ
  #define UART_MON_P1_TX     -1    // P2 TXD0 reserved for NRF24 CE
#else
...
#elif defined(ESP32S3_ES3C28P)
  #define BOOT_BUTTON       0    // GPIO0 BOOT key, not broken out
  #define BOOT_BUTTON_USABLE 1
#else
...
// For 2.8" (240x320):
    ...
    // FT6336 capacitive panel: keep the icon bar reserved for the visible
    // top-left back icon. The old top-left UP zone can swallow back taps.
    #define TOUCH_BTN_UP_X1      0
    #define TOUCH_BTN_UP_Y1     62
    #define TOUCH_BTN_UP_X2     80
    #define TOUCH_BTN_UP_Y2    105

    #define TOUCH_BTN_BACK_X1    0
    #define TOUCH_BTN_BACK_Y1    0
    #define TOUCH_BTN_BACK_X2   64
    #define TOUCH_BTN_BACK_Y2   58
  #else
    // UP button - top left
    #define TOUCH_BTN_UP_X1      0
...
// ═══════════════════════════════════════════════════════════════════════════
  ...
  #define CYD_HAS_AUDIO     0
  #define CYD_HAS_SPEAKER   0
  #define CYD_HAS_PCF8574   0
  #define CYD_HAS_PN532     1
#elif defined(ESP32S3_ES3C28P)
  #define CYD_HAS_CC1101    0     // No SubGHz wiring assigned for this S3 target yet
  #define CYD_HAS_NRF24     1     // NRF24L01+PA+LNA on P3 + P2 once wired
  #define CYD_HAS_GPS       0     // P2 UART pins are reserved for NRF24 CE/IRQ
  #define CYD_HAS_SDCARD    1     // Native SD_MMC on GPIO38/39/40/41/47/48
  #define CYD_HAS_RGB_LED   1     // Onboard WS2812 on GPIO42 is still available
  #define CYD_HAS_AUDIO     1     // ES8311 codec + onboard mic over I2S/I2C
  #define CYD_HAS_SPEAKER   1     // ES8311 speaker path available
  #define CYD_HAS_PCF8574   0     // No I2C button expander
  #define CYD_HAS_PN532     0     // No PN532 wiring assigned for this S3 target yet
#else
...
#elif defined(ESP32S3_ES3C28P)
  #define CYD_HAS_BATTERY     1     // Battery ADC on GPIO9
  #define CYD_BATTERY_ADC     9
  #define CYD_BATTERY_DIVIDER_RATIO 2.0f
  #define CYD_HAS_AMP         0     // Legacy CYD amp path unused; ES8311_PA_EN handles S3 audio
  #define ES8311_SDA         16
  #define ES8311_SCL         15
  #define ES8311_PA_EN        1
  #define ES8311_MCLK         4
  #define ES8311_BCLK         5
  #define ES8311_DIN          6
  #define ES8311_LRCLK        7
  #define ES8311_DOUT         8
#elif defined(CYD_E32R28T) || defined(CYD_E32R35T)
...
// Icon bar TOUCH zones (generous for fat fingers on larger/capacitive panels)
#if defined(CYD_35) || defined(ESP32S3_ES3C28P) || defined(ESP32C5_NM_CYD)
...
#define SUBMENU_TOUCH_H     SCALE_Y(46)     // Touch hit area height (matches paginated button height)
